...
if (isset($_SERVER['SCRIPT_NAME']))
	$_SERVER['SCRIPT_NAME']=str_replace('assets/modules/cacheallpages/ajaxCacheAllPages', 'index', $_SERVER['SCRIPT_NAME']);
if (isset($_SERVER['PHP_SELF']))
	$_SERVER['PHP_SELF']=str_replace('assets/modules/cacheallpages/ajaxCacheAllPages', 'index', $_SERVER['PHP_SELF']);
